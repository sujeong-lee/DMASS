...
sys_weights = True
SP_run1 = True  # other sp maps in non-band folders
...
for y in range(y_all):
    if y<y1:
        for x in range(4):
            ...
            pcenter, norm_number_density, error_cov, fracerr_norm = go_through_SP(full_path, input_keyword, fracHp, cov, i_mock, dmass_chron, dmass_chron_weights, sys_weights = sys_weights)
