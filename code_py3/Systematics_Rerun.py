...
#    random_chron = downgrade_ran(random_val_fracselected)
    ...
    dmass_chron=fitsio.read('/fs/scratch/PCON0008/warner785/bwarner/dmass_sys_weight_rerun5.fits')
...
#        print(dmass_chron["SYS_WEIGHT"], dmass_chron["SYS_WEIGHT"].size)
        ...
        esutil.io.write( outdir+xlabel+'dmass_sys_weight_rerun5.fits', dmass_chron, overwrite=True)
        esutil.io.write( outdir+xlabel+'h_ran_rerun5.fits', h_ran, overwrite=True)
        esutil.io.write( outdir+xlabel+'norm_ran_rerun5.fits', norm_number_density_ran, overwrite=True)
        esutil.io.write( outdir+xlabel+'fracerr_ran_rerun5.fits', fracerr_ran_norm, overwrite=True)
        
        
# save everything in text files
    np.savetxt('chi2_randoms_rerun5.txt', chi2_randoms)
    np.savetxt('chi2_dmassi_rerun5.txt', chi2_dmassi)
    np.savetxt('chi2_trend1_rerun5.txt', chi2_trend1)
    np.savetxt('chi2_trend2_rerun5.txt', chi2_trend2)
    np.savetxt('trend_rerun5.txt', trend)
