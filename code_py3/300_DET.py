...
mask2 =(gold_st82['RA']>18)&(gold_st82['RA']<43)
...
gold_xd_bovy_filename = outdir+'gauss_gold_bovyY3_300DET_unfixed.xdgmm'
...
outdir = 'output/test/fitting/'
os.makedirs(outdir, exist_ok=True)
gold_xd_bovy_filename = outdir+'gauss_nogold_bovyY3_300DET_unfixed.xdgmm'
